...
import 'empty_stats_model.dart';

class EmptyStats extends StackedView<EmptyStatsModel> {
  bool abbreviated;
  EmptyStats({super.key, this.abbreviated = false});

  @override
  Widget builder(
    BuildContext context,
    EmptyStatsModel viewModel,
    Widget? child,
  ) {
    return SizedBox(
  ...
  @override
  EmptyStatsModel viewModelBuilder(
    BuildContext context,
  ) =>
      EmptyStatsModel();
}
