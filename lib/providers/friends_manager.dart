...
class FriendsManager {
  ...
  Stream<List<FriendRequest>> get receivedFriendRequestsStream => _friendsDatabase.getReceivedFriendRequestsStream();

  Stream<List<FriendRequest>> get sentFriendRequestsStream => _friendsDatabase.getSentFriendRequestsStream();
